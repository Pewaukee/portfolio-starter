export const homeData = [
  {
    ...
    icons: ['/svg/hobbies/code.svg', '/svg/hobbies/book.svg'],
    title: ['$ whoami'],
  ...
  },
  {
    ...
    icons: [
      '/svg/hobbies/chess/chess_clock.svg',
      '/svg/hobbies/chess/king.svg',
    ],
  ...
  },
  {
    ...
    icons: ['/svg/hacker/hacker.svg', '/svg/hacker/defense.svg'],
